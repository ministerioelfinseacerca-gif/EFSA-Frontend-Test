...
export default function Recursos() {
  return (
    <section id="recursos-edificacion" className="py-20 sm:py-28 px-6 sm:px-8 md:px-12 lg:px-16 border-t border-gold-base/10 bg-transparent font-[family-name:var(--font-montserrat)]">
      <div className="max-w-7xl mx-auto flex flex-col gap-12 sm:gap-16">
        
        {/* Title */}
        <div className="w-full">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-efsa-red mb-4">
            Biblioteca Digital
          </p>
          <TextReveal
            as="h2"
            className="font-black text-4xl sm:text-5xl text-gold-highlight uppercase tracking-tight mb-6"
          >
          ...
          <div className="bg-surface-container-lowest border border-gold-base/20 p-8 md:p-12 flex flex-col justify-between gap-8 relative group hover:border-gold-base/40 transition-colors duration-300">
            <div className="flex flex-col gap-6 relative z-10">
              ...
              <div className="flex flex-col gap-4">
                <h3 className="font-black text-3xl text-gold-highlight uppercase tracking-tight">
                  MATERIAL DE ESTUDIO
                </h3>
                <p className="font-light text-base text-on-surface opacity-70 leading-relaxed max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 relative z-10">
              ...
              <a
                href="#bosquejos"
                className="inline-flex items-center justify-center border-2 border-gold-base/40 text-gold-base font-black text-sm uppercase tracking-widest px-8 py-4 hover:bg-gold-base hover:text-navy-midnight transition-colors duration-300"
              >
                BOSQUEJOS
              </a>
            </div>
